...
## 合計(実測分のみ / 未取得 24品目を含まず)

```
2枚分の発注総額       12,572円 以上
1枚あたり(発注額÷2)       6,286円 以上   ← 予備・端数込みの実支出
1枚あたり(正味BOM)          5,570円 以上   ← 員数ぶんだけの原価
```
...
## ★価格未取得 (24品目) — 上の合計に**含まれていません**

| 部品 | 発注数 | 仕入先 |
|---|---:|---|
| (module) (品番なし) | 2 | LCSC |
| C1, C2, C3, C4, C5, C7, C60, C63,  CL21A106KAYNNNE | 36 | DK |
...
| U2, U8, U10, U11, U12 SN74LVC2G17DBVR | 12 | DK |
