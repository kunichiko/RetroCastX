...
|---|---|---|---|---|---|---|---|---|---|
| 信号 | GND | **HS** | R | G | B | I | **VS** | GND | GND |

8極では信号6本+GND2本しか取れないので「どの2本をGNDの隣に置くか」を選ぶ必要がある。
**フレーム全体を壊すのは同期の誤り**なので、HS/VSを端(GND隣)に置き、ドットクロック
速度でトグルする色4bitを中央にまとめた。ケーブルが長くノイズが出る場合は同シリーズの
...
| 信号 | SO-DIMM | ボール | 備考 |
|---|---|---|---|
| drgb_hs | 132 | F3 | **PCLKC7_1**(クロック対応)。将来HSをPLL基準に使う余地 |
| drgb_r | 136 | H3 | |
| drgb_g | 140 | H5 | |
| drgb_b | 142 | J4 | |
| drgb_i | 144 | J5 | |
...
残るクロック対応ボール **G3(PCLKT7_1) / H4(GR_PCLK7_1) は未接続のまま予備**に残してある
