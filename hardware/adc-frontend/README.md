...
データシートは**未使用のアナログ入力を10nFでGNDへ落とす**よう指定している
("Unused analog inputs should be connected to ground using a 10-nF capacitor")。
現状 rin_1/2, gin_1/2/4, bin_1/2, sogin_1/2 は開放のまま。次版で対応する。
