...
const REGS_X68000: InputRegs = &[
    ...
    (proto::CFG_KEY_GAIN_B, 35, "青ファインゲイン(v0.9.0校正: プラトー31〜39の中央)"),
    (proto::CFG_KEY_GAIN_G, 39, "緑ファインゲイン(v0.9.0校正: 35〜43の中央。旧33は1つ下)"),
    (proto::CFG_KEY_GAIN_R, 43, "赤ファインゲイン(v0.9.0校正: 39〜47の中央。旧39は下端)"),
